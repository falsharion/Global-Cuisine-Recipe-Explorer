...
// import AuthPage from "./component/auth/AuthPage"; // Handle login/signup together
...
//           </>
//         } />
//         <Route path="auth" element={<AuthPage />} /> {/* Combine login/signup here */}
//         <Route path="login" element={<AuthPage />} /> {/* Or simply redirect to auth */}
...
//   const { favorites, addFavorite, removeFavorite } = useFavorites();  // Get favorites from FavoritesContext
...
//   useEffect(() => {
//     // If the user is logged out, navigate to login page
//     if (!currentUser) {
//       navigate("/auth");
//     }
...
//             <Banner />
//             <Recipe query={query} favorites={favorites} addFavorite={addFavorite} removeFavorite={removeFavorite} />
//           </>
//         } />
        
//         {/* Authentication routes */}
//         <Route path="auth" element={<AuthPage />} />
//         <Route path="login" element={<AuthPage />} /> {/* Redirect to auth */}
...
//     </Routes>
//   );
// }i want the input search to not work when user try to search it should direct the user to login if they are not logged in yet but if they are logged in the input search should work
